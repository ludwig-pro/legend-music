...
## Steps
- [ ] Add a `SplitView` wrapper in `src/native-modules/SplitView.tsx` using `requireNativeComponent("RNSplitView")`, `cssInterop`, and typed props (`isVertical`, `dividerThickness`, `onSplitViewDidResize`).
