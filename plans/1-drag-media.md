...
- [ ] Add draggable affordances to media library items emitting track payloads.
- [ ] Make the main playlist droppable and handle track insertion logic with persistence.
