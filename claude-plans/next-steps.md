...
[] Hovering over the playback area should display the current time and duration. See @PlaybackArea.tsx and that display code is already in there but commented out.
