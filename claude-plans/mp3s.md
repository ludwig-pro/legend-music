...
[] Dropdown menus should activate on mouse down rather than click. If the mouse is already down when it's opened, mouse up should activate the selected item.
