        ...
        <View className="flex-1 bg-background-primary">
            <ScrollView className="flex-1" contentContainerStyle={{ padding: 32 }}>
                <View className="max-w-4xl mx-auto">
                    <Text className="text-3xl font-bold text-white mb-8">Open Source</Text>
                    ...
                    <View className="mb-10 p-6 bg-white/5 rounded-xl border border-white/10">
                        ...
                        <Text className="text-white/80 text-base leading-relaxed mb-6">
                            Legend Music is completely free and open source. You can view the source code, contribute to
                            its development, and even create your own version. We believe in transparency and
                    ...
                    <View className="p-6 bg-white/5 rounded-xl border border-white/10">
                        <Text className="text-white/80 text-base leading-relaxed text-center">
                            We're grateful to all the maintainers and contributors of these projects. Open source
                            software makes amazing applications like Legend Music possible.
                        </Text>
                    </View>
                </View>
            </ScrollView>
