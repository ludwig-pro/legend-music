...
export function AccountSettings() {
    ...
    if (isRegistered) {
        return (
            <SettingsPage title="Account" scroll contentClassName="px-8 py-8">
                <View className="max-w-3xl mx-auto space-y-8">
                    <View className="p-8 bg-green-500/20 rounded-xl border border-green-400/30 shadow-lg">
    ...
    return (
        <SettingsPage title="Account" scroll contentClassName="px-8 py-8">
            <View className="max-w-3xl mx-auto space-y-10">
                <View className="p-6 bg-white/5 rounded-xl border border-white/10">
                    <Text className="text-xl font-semibold text-white mb-4">Legend Music is Free & Open Source</Text>
                    <Text className="text-white/80 text-base leading-relaxed">
                        ...
                        continue improving this app and developing other Legend tools. Your support helps us dedicate
                        more time to creating amazing music applications.
                    </Text>
                </View>
                ...
                <View className="space-y-6">
                    ...
                    <View className="p-8 bg-white/5 rounded-xl border border-white/10">
                        <Text className="text-xl font-semibold text-white mb-4">💝 Standalone Registration - $9</Text>
                ...
                <View className="p-6 bg-white/5 rounded-xl border border-white/10">
                    <Text className="text-white/80 text-base leading-relaxed">
                        ...
                        time improving Legend Music, fixing bugs, adding features, and creating new Legend apps. Even if
                        you choose not to register, you'll always have access to the full app.
                    </Text>
                </View>
            </View>
        </SettingsPage>
