...
class KeyboardManager {
    ...
    constructor() {
        this.isNativeModuleAvailable = Platform.OS === "macos" && !!RNKeyboardManager && !!keyboardEventEmitter;
    ...
    addKeyDownListener(listener: KeyboardEventListener): () => void {
        ...
        return () => {
            ...
            if (this.keyDownListeners.length === 0 && this.keyUpListeners.length === 0 && this.isMonitoring) {
                this.stopMonitoring();
            }
        };
    }
