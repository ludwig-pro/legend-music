...
- Local-first and private: uses your folders, reads ID3/JS tags, caches artwork, and never uploads your library.
...
- Native playback: AVPlayer-based engine with MediaRemote hooks, Now Playing metadata, hotkeys, and FFT data for the visualizer.
